...
<div class="container">
        ...
        <div class="card">
        <div class="card-header" style="font-size:25px; background-color: #ea9999; color: white;" >Edit Produk atau Paket Dekorasi</div>
            <div class="card-body" style="color:black">
                ...
                <form method="POST" action="{{url('list/decoration/product/update')}}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id_jasa_dekorasi" value="{{$id}}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="nama" name="nama_paket" value="{{$data->NAMA_PAKET}}">
                        </div>
