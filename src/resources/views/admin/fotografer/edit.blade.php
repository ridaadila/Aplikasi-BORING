...
<div class="container">
        ...
        <div class="card">
        <div class="card-header" style="font-size:25px; background-color: #ea9999; color: white;" >Edit Fotografer</div>
            <div class="card-body" style="color:black">
                    ...
                    <form method="POST" action="{{url('list/photography/update')}}" enctype="multipart/form-data">
                        @csrf
