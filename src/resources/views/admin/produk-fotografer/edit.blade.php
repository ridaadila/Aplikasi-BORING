...
<div class="container">
        ...
        <div class="card">
        <div class="card-header" style="font-size:25px; background-color: #ea9999; color: white;" >Edit Paket atau Produk Fotografer</div>
            <div class="card-body" style="color:black">
                ...
                <form method="POST" action="{{url('list/photography/product/update')}}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id_produk_jasa_fotografer" value="{{$id}}">
