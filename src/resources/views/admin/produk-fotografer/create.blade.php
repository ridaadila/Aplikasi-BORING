...
<div class="container">
        ...
        <div class="card">
        <div class="card-header" style="font-size:25px; background-color: #ea9999; color: white;" >Tambah Produk atau Paket Fotografer</div>
            <div class="card-body" style="color:black">
                ...
                <form action="{{url('list/photography/product/insert')}}" method="POST" enctype="multipart/form-data">
                @csrf
