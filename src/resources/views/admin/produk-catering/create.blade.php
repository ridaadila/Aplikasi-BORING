...
<div class="container">
        ...
        <div class="card">
        <div class="card-header" style="font-size:25px; background-color: #ea9999; color: white;" >Tambah Produk atau Paket Catering</div>
            <div class="card-body" style="color:black">
                ...
                <form action="{{url('list/catering/product/insert')}}" method="POST" enctype="multipart/form-data">
                @csrf
