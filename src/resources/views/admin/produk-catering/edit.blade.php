...
<div class="container">
        ...
        <div class="card">
        <div class="card-header" style="font-size:25px; background-color: #ea9999; color: white;" >Edit Produk atau Paket Catering</div>
            <div class="card-body" style="color:black">
                ...
                <form method="POST" action="{{url('list/catering/product/update')}}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id_jasa_catering" value="{{$id}}">
